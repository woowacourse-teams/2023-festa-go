...
class ExistsTicketStageUpdateValidatorTest {

    ExistsTicketStageUpdateValidator existsTicketStageUpdateValidator;
    ...
    void setUp() {
        ...
        existsTicketStageUpdateValidator = new ExistsTicketStageUpdateValidator(stageTicketRepository);
    }
    ...
    class validate {
        ...
        void 공연에_티켓이_등록_되어있으면_예외() {
            ...
            // when & then
            assertThatThrownBy(() -> existsTicketStageUpdateValidator.validate(stage))
                .isInstanceOf(BadRequestException.class)
                .hasMessage(ErrorCode.STAGE_UPDATE_CONSTRAINT_EXISTS_TICKET.getMessage());
        }
        ...
        void 공연에_티켓이_없으면_예외가_발생하지_않는다() {
            ...
            // when & then
            assertDoesNotThrow(() -> existsTicketStageUpdateValidator.validate(stage));
        }
    }
}
