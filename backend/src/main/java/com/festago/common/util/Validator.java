...
public final class Validator {
    ...
    private static final String MAX_STRING_LENGTH_VALIDATION_MESSAGE = "최대 길이는 0보다 커야합니다.";
    private static final String MIN_STRING_LENGTH_VALIDATION_MESSAGE = "최소 길이는 0보다 커야합니다.";
    private static final String MAX_VALUE_VALIDATION_MESSAGE = "최대 값은 0보다 커야합니다.";
    private static final String MIN_VALUE_VALIDATION_MESSAGE = "최소 값은 0보다 커야합니다.";
    ...
    public static void maxLength(CharSequence input, int maxLength, String message) {
        if (maxLength <= 0) {
            throw new IllegalArgumentException(MAX_STRING_LENGTH_VALIDATION_MESSAGE);
        }
        // avoid NPE
        if (input == null) {
            return;
     ...
     * @throws ValidException           문자열의 길이가 초과되면
     */
    public static void maxLength(CharSequence input, int maxLength, Supplier<String> message) {
        if (maxLength <= 0) {
            throw new IllegalArgumentException(MAX_STRING_LENGTH_VALIDATION_MESSAGE);
        }
        // avoid NPE
        ...
        if (input.length() > maxLength) {
            throw new ValidException(message.get());
        }
    }
    ...
    public static void minLength(CharSequence input, int minLength, String message) {
        if (minLength <= 0) {
            throw new IllegalArgumentException(MIN_STRING_LENGTH_VALIDATION_MESSAGE);
        }
        // avoid NPE
        if (input == null) {
            return;
     ...
     * @throws ValidException           문자열의 길이가 작으면
     */
    public static void minLength(CharSequence input, int minLength, Supplier<String> message) {
        if (minLength <= 0) {
            throw new IllegalArgumentException(MIN_STRING_LENGTH_VALIDATION_MESSAGE);
        }
        // avoid NPE
    ...
    public static void maxValue(int value, int maxValue, String message) {
        if (maxValue <= 0) {
            throw new IllegalArgumentException(MAX_VALUE_VALIDATION_MESSAGE);
        }
        if (value > maxValue) {
            throw new ValidException(message);
        }
     ...
     * @throws IllegalArgumentException 최대 값이 0 이하이면
     */
    public static void maxValue(int value, int maxValue, Supplier<String> message) {
        if (maxValue <= 0) {
            throw new IllegalArgumentException(MAX_VALUE_VALIDATION_MESSAGE);
        }
        if (value > maxValue) {
     ...
     * @throws IllegalArgumentException 최대 값이 0 이하이면
     */
    public static void maxValue(long value, int maxValue, Supplier<String> message) {
        if (maxValue <= 0) {
            throw new IllegalArgumentException(MAX_VALUE_VALIDATION_MESSAGE);
        }
        if (value > maxValue) {
    ...
    public static void minValue(int value, int minValue, String message) {
        if (minValue <= 0) {
            throw new IllegalArgumentException(MIN_VALUE_VALIDATION_MESSAGE);
        }
        if (value < minValue) {
            throw new ValidException(message);
        }
     ...
     * @throws IllegalArgumentException 최소 값이 0 이하이면
     */
    public static void minValue(int value, int minValue, Supplier<String> message) {
        if (minValue <= 0) {
            throw new IllegalArgumentException(MIN_VALUE_VALIDATION_MESSAGE);
        }
        if (value < minValue) {
     ...
     * @throws IllegalArgumentException 최소 값이 0 이하이면
     */
    public static void minValue(long value, int minValue, Supplier<String> message) {
        if (minValue <= 0) {
            throw new IllegalArgumentException(MIN_VALUE_VALIDATION_MESSAGE);
        }
        if (value < minValue) {
