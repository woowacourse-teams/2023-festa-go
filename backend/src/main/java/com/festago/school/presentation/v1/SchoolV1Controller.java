...
public class SchoolV1Controller {
    ...
    public ResponseEntity<List<SchoolFestivalV1Response>> findFestivalsBySchoolId(
        ...
        List<SchoolFestivalV1Response> response = schoolV1QueryService.findFestivalsBySchoolId(schoolId, today,
            lastFestivalId,
            lastStartDate, isPast, size);
        return ResponseEntity.ok(response);
    }
}
